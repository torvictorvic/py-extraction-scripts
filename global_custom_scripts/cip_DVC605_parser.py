...
class Extractor:
    ...
    def run(filename, **kwargs):
        ...
        try:
            positions = [0,44,46,49,50,52,56,60,67,70,78,84,96,103,113,131,139,147,150,160]
            col_specification =[]
            ...
            cols = ["codigo_de_barras", "filler_1", "filler_2", "tipo_de_captura","motivo_de_devolucao","filler_3", "agencia_remetente", "n_do_lote", "sequencial_do_lote", "data_do_movimento", "centro_processador", "valor_liquido_do_titulo", "versao_do_arquivo", "sequencial_do_arquivo_de_troca", "filler_4", "ispb_if_recebedor", "ispb_if_favorecida", "tipo_de_documento","sequencial_de_arquivo"]   
