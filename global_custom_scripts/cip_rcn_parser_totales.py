...
class Extractor:
    ...
    def run(filename, **kwargs):
        ...
        #df.columns = ['total','Pag','nossa_remessa','resultado_liquidacion','total_general','total_015','total_040']
        df.columns = ['total','Pag','nossa_remessa','resultado_liquidacion','total_general','total_015','total_040','total_041','total_058','total_093']
        #df = pd.DataFrame(df.columns)        
