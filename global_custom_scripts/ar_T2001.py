        ...
        },
        {
            ...
            "layout": [
                ...
                ,{
                    "start_at":454,
                    "ends_at":466,
                    "column_name":"importe_movimiento_convertido"
                }
                ,{
                    "start_at":467,
                    "ends_at":467,
                    "column_name":"signo_importe_convertido"
                }
                ,{
                    "start_at":468,
                    "ends_at":480,
                    "column_name":"importe_percep_RG3450"
                }
                ,{
                    "start_at":481,
                    "ends_at":481,
                    "column_name":"signo_percep_RG3450"
                }
                ,{
                    "start_at":482,
                    "ends_at":484,
...
formato = ['raw_body', 'tipo_resgitro', 'numero_tarjeta', 'marca',
            ...
            'signo', 'local_Internacional', 'filler_2', 'tipo_resgistro_h',
...
class Extractor:
    ...
    def run(filename, **kwargs):
        ...
        with open('archivo.rar', 'wb') as f:
            f.write(file)
        #mydir= "/tmp/{}/".format(filename.split('.rar')[0].split('/')[-1])
        #try:
        #    shutil.rmtree(mydir)
        #except FileNotFoundError:
        #    pass
        file_2=patoolib.extract_archive("archivo.rar")
        #for archive in os.listdir(mydir):
        try:
            with open(file_2,encoding='latin1') as f_2:
                raw_data = f_2.readlines()
                print("Abriendo rar: ",file_2)
            final = []
            for raw in raw_data:
                final.append(raw)
