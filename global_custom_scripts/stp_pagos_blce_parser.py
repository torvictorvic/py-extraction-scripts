...
class Extractor:
    ...
    def run(self, filename, **kwargs):
        ...
        cols = ['fecha_pago_bancario', 'numero_cuenta_bancaria', 'numero_cuenta_sap',
       'numero_extracto', 'saldo_inicial', 'saldo_final',
       'tipo_operacion_saldo_inicial', 'tipo_operacion_saldo_final']
